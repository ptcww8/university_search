     ...
     <article
        ...
        <figure className="atbd_listing_thumbnail_area">
           <div className="atbd_listing_image">
              <a href={this.props.university.web_pages[0]} target="_blank">
           ...
           <div className="atbdp_add_to_fav_listings"><a target="_blank" className="atbdp_mark_as_fav " id="atbdp-fav_2855" data-listing_id="2855" href={this.props.university.web_pages[0]}><span className="atbd_fav_icon"></span><span className="atbd_fav_tooltip"></span></a></div>
        </figure>
        <div className="atbd_listing_info">
           <div className="atbd_content_upper">
              <h4 className="atbd_listing_title">
                 <a href={this.props.university.web_pages[0]} target="_blank">{this.props.university.name}</a>
              </h4>
           </div>
        </div>
     </article>
